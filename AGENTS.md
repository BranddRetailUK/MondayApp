...
At the start of every chat in this repository, read `contract.md` one time first to gain service context before making changes or answering implementation questions.
